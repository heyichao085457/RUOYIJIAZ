...
import {
  ...
  options,
  exportList,
  exportTbJscEcharts2022,
  computeList,
  jscId,
  computeList2022,
  deleteId,
  exportRhJscEcharts2022,
  DropdownBoXContent,
  jscEchartsexportTbJscEcharts,
...
import echartsio from "../Dataupload/echatr.vue";
import echartsiotow from "../Dataupload/echatrtow.vue";
import ChartComponent from "../Dataupload/columnar.vue";
import { EventBus } from "../Dataupload/eventBus.js";
import twoeree from "../Dataupload/columnartwo.vue";
export default {
  components: {
    VueOfficeExcel,
    screen,
  ...
  methods: {
    ...
    reportName(params, clickedButton = "面积") {
      exportTbJscEcharts2022(params).then((ok) => {
    ...
    listpsms(params, clickedButton = "面积") {
      this.loading = true;
      exportRhJscEcharts2022(params).then((ok) => {
