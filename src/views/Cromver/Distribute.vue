<template>
  <div class="container">
    <div class="line"></div>
    <div class="sellect">
      <el-form ref="form" :model="issuedTb2024" label-width="55px">
        <div>
          <el-row class="title" type="flex" align="middle">
            <el-col :span="4">
              <el-form-item label="行政区">
                <el-cascader
                  ref="cascader"
                  clearable
                  v-model="issuedTb2024.selectXZQ"
                  :options="xzq"
                  :style="{ width: '100%' }"
                  :props="{
                    value: 'value',
            ...
            <el-col :span="5">
              <el-date-picker
                v-model="issuedTb2024.valuetime"
                type="daterange"
                range-separator="至"
            ...
            <el-col :span="4" :style="{ marginLeft: '15px' }">
              <el-input
                ...
                v-model.trim="issuedTb2024.dkOrTb"
                clearable
    ...
    <div class="table-container">
      ...
      >
        ...
        >
          <template slot-scope="scope">
            <el-tooltip :content="scope.row.xfpc" placement="top" effect="dark">
              <div class="address-cell">
                {{ scope.row.xfpc }}
              </div>
            </el-tooltip>
        ...
        >
          <template slot-scope="scope">
            <el-tooltip :content="scope.row.bz" placement="top" effect="dark">
              <div class="address-cell">
                {{ scope.row.bz }}
              </div>
            </el-tooltip>
        ...
        <el-table-column
          prop="ysxwpdlrdjbntmj"
          :resizable="false"
          align="center"
          label="有手续卫片地类认定基本农田面积"
          width="230"
        >
          <!-- <template slot-scope="scope">
            <el-tooltip
              :content="scope.row.qtjtqx"
              placement="top"
              effect="dark"
            >
              <div class="address-cell">
        ...
        <el-table-column
          prop="wsxwpdlrdjbntmj"
          :resizable="false"
          align="center"
          label="无手续卫片地类认定基本农田面积"
          width="230"
        >
        </el-table-column>
        <el-table-column
        ...
        <el-table-column
          prop="ysxwpdlrdjsydmj"
          :resizable="false"
          align="center"
          label="有手续卫片地类认定建设用地面积"
          width="230"
        >
        </el-table-column>
        <el-table-column
          prop="wsxwpdlrdjsydmj"
          :resizable="false"
          align="center"
          label="无手续卫片地类认定建设用地面积"
          width="230"
        >
        </el-table-column>
        <el-table-column
        ...
        <el-table-column
          prop="ysxwpdlrdwlydmj"
          :resizable="false"
          align="center"
          label="有手续卫片地类认定未利用地面积"
          width="230"
        >
        </el-table-column>
        <el-table-column
          prop="wsxwpdlrdwlydmj"
          :resizable="false"
          align="center"
          label="无手续卫片地类认定未利用地面积"
          width="230"
        >
        </el-table-column>
        <el-table-column
        ...
        <el-table-column
          ...
          :resizable="false"
          align="center"
          label="2010-至今农转用建设用地项目图斑"
          width="230"
        >
          <template slot-scope="scope">
            <el-tooltip
              :content="scope.row.zjnzyjsydxm"
              placement="top"
              effect="dark"
            >
              <div class="address-cell">
                {{ scope.row.zjnzyjsydxm }}
              </div>
            </el-tooltip>
          </template>
        </el-table-column>
        ...
        <el-table-column
          ...
          :resizable="false"
          align="center"
          label="增减挂钩项目拆旧区_2018 及前"
          width="230"
        >
          <template slot-scope="scope">
            <el-tooltip
              :content="scope.row.zjggxmcjq"
              placement="top"
              effect="dark"
            >
              <div class="address-cell">
        ...
        <el-table-column
          ...
          :resizable="false"
          align="center"
          label="增减挂钩项目建新区_2018 及前"
          width="230"
        >
          <template slot-scope="scope">
            <el-tooltip
              :content="scope.row.zjggxmjxq"
              placement="top"
              effect="dark"
            >
              <div class="address-cell">
        ...
        <el-table-column
          ...
          :resizable="false"
          align="center"
          label="2018 年前工矿废弃地复垦项目"
          width="200"
        >
          <template slot-scope="scope">
            <el-tooltip
              :content="scope.row.gkfqdfgxm"
              placement="top"
              effect="dark"
            >
              <div class="address-cell">
        ...
        <el-table-column
          ...
          :resizable="false"
          align="center"
          label="2018 年前未利用地开发项目"
          width="200"
        >
          <template slot-scope="scope">
            <el-tooltip
              :content="scope.row.wlydkfxm"
              placement="top"
              effect="dark"
            >
              <div class="address-cell">
        ...
        <el-table-column
          ...
          :resizable="false"
          align="center"
          label="图斑范围占面积最大的矿权信息"
          width="230"
        >
          <template slot-scope="scope">
            <el-tooltip
              :content="scope.row.tbfwzmjzdkqxx"
              placement="top"
              effect="dark"
            >
              <div class="address-cell">
                {{ scope.row.tbfwzmjzdkqxx }}
              </div>
            </el-tooltip>
          </template>
        </el-table-column>
        ...
        >
          <template slot-scope="scope">
            <el-tooltip
              :content="scope.row.tbfwqtkqxx"
              placement="top"
              effect="dark"
            >
              <div class="address-cell">
                {{ scope.row.tbfwqtkqxx }}
              </div>
            </el-tooltip>
          </template>
        </el-table-column>
        ...
        >
          <template slot-scope="scope">
            <el-tooltip
              :content="scope.row.mjzbzdxzjmc"
              placement="top"
              effect="dark"
            >
              <div class="address-cell">
                {{ scope.row.mjzbzdxzjmc }}
              </div>
            </el-tooltip>
          </template>
        </el-table-column>
        ...
        >
          <template slot-scope="scope">
            <el-tooltip
              :content="scope.row.mjzbzbcjdm"
              placement="top"
              effect="dark"
            >
              <div class="address-cell">
                {{ scope.row.mjzbzbcjdm }}
              </div>
            </el-tooltip>
          </template>
        </el-table-column>
        ...
        >
          <template slot-scope="scope">
            <el-tooltip
              :content="scope.row.mjzbzbcjmc"
              placement="top"
              effect="dark"
            >
              <div class="address-cell">
                {{ scope.row.mjzbzbcjmc }}
              </div>
            </el-tooltip>
          </template>
        </el-table-column>
    ...
    >
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <script>
import screen from "../Enforcementxiang/Distributescreen.vue";
...
export default {
  ...
  methods: {
    ...
    saveFormData() {
      // 创建formDatahut的副本
      let dataToStore = { ...this.issuedTb2024 };
      ...
      localStorage.setItem("issuedTb2024", JSON.stringify(dataToStore));
    },
    loadFormData() {
      const savedData = localStorage.getItem("issuedTb2024");
      if (savedData) {
        this.issuedTb2024 = JSON.parse(savedData);
      }
    },
    // saveFormData() {
    //   localStorage.setItem("issuedTb2024", JSON.stringify(this.issuedTb2024));
    // },
    // loadFormData() {
    //   const savedData = localStorage.getItem("issuedTb2024");
    //   if (savedData) {
    ...
    beforeRouteEnter(to, from, next) {
      next((vm) => {
        if (to.params.savedData) {
          vm.issuedTb2024 = to.params.savedData;
        }
      });
    },
    handleDateChange(dates) {
      if (Array.isArray(dates) && dates.length > 0) {
        ...
        this.issuedTb2024.startDate = formattedDates[0];
        this.issuedTb2024.endDate = formattedDates[1];
      } else {
        this.issuedTb2024.startDate = "";
        this.issuedTb2024.endDate = "";
      }
    },
    emitGetju(data) {
      //   console.log(data);
      this.issuedTb2024.cxbhlx = data.cxbhlx;
      this.issuedTb2024.xftblx = data.xftblx;
      this.issuedTb2024.sfcf = data.sfcf;
      this.issuedTb2024.tbfl = data.tbfl;
      this.issuedTb2024.wyzt = data.wyzt;
      this.issuedTb2024.hcjd = data.hcjd;
      this.issuedTb2024.hczt = data.hczt;
    ...
    qualityinspection() {
      ...
      formData.append("file", this.selectedFile);
      this.loadingxlsx = true;
      issuedimportXftb(formData).then((res) => {
        if (res.code === 200) {
          this.loadingxlsx = false;
          this.checkListt();
          this.$message.success("上传成功");
    ...
    terDialog() {
      this.issuedTb2024.remarks = this.namerow;
      let data = { ...this.issuedTb2024 };
    ...
    exportData() {
      ...
      issuedexporter(this.issuedTb2024).then((res) => {
        if (res.code === 200) {
          load.close();
          this.exportCurrentList2();
        }
      ...
      //   let exportRhtz2024 = {
      //     city: this.issuedTb2024.city,
      //     county: this.issuedTb2024.county,
      //     ssqx: this.issuedTb2024.ssqx,
      //     cancelStatus: this.issuedTb2024.cancelStatus,
      //     checkDetermineResult: this.issuedTb2024.checkDetermineResult,
      //     startDate: this.issuedTb2024.startDate,
      //     endDate: this.issuedTb2024.endDate,
      //     checkJobName: this.issuedTb2024.checkJobName,
      //     dkOrTb: this.issuedTb2024.dkOrTb,
      //     snapdate: this.issuedTb2024.snapdate,
      //     checkMethod: this.issuedTb2024.checkMethod,
      //     sfwttb: this.issuedTb2024.sfwttb,
      //     pdlx: this.issuedTb2024.pdlx,
    ...
    downLoadTemplate() {
      if (this.uploadButton === "模版下载") {
        window.open(
          "http://124.114.203.222:8084/downloads/下发图斑导入模板.xlsx"
        );
      } else {
    ...
    handleEditClick(value) {
      this.$router.push({
        path: "/Enforcementxiang/Distributexiang",
        query: {
          id: value.id,
    ...
    handleCurrentChange(value) {
      ...
      this.issuedTb2024.pageNum = value;
      this.findAll();
    },
    ...
    handleChangeXzq(value) {
      this.issuedTb2024.city = "";
      this.issuedTb2024.county = "";
      if (value.length) {
        const textArr = [];
        ...
        this.issuedTb2024.city = arr.join(",");
        this.issuedTb2024.county = county.join(",");
      }
    },
    //数组转对象
    arrayToObject(arr) {
    ...
    findAll(isSearch) {
      ...
      // }
      if (this.issuedTb2024.snapdate) {
        this.issuedTb2024.snapdate = this.formatDate(
          this.issuedTb2024.snapdate
        );
      }

      const { selectXZQ, valuetime, ...params } = this.issuedTb2024;
