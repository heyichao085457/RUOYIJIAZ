<template>
  <div class="container">
    <div class="line"></div>
    <div class="sellect">
      <el-form ref="form" :model="formData12" label-width="55px">
        <div>
          <el-row class="title" type="flex" align="middle">
            ...
            <el-col :span="4" :style="{ marginLeft: '15px' }">
              <el-input
                size="medium"
                placeholder="请输入图斑编号"
                v-model.trim="formData12.dkOrTb"
                clearable
...
export default {
  ...
  methods: {
    ...
    clearFormData() {
      this.formData12.tbmjMin = "";
      this.formData12.tbmjMax = "";
      this.formData12.tbmj = "";
      this.formData12.dydytbmj = "";
      this.formData12.xydytbmj = "";
    },
    onSubprimary() {
      this.clearFormData();
      switch (this.customValue.condition) {
        case "1":
          this.formData12.tbmjMax = this.customValue.value;
          break;
        case "2":
          this.formData12.tbmjMin = this.customValue.value;
          break;
        case "3":
          this.formData12.tbmj = this.customValue.value;
          break;
        case "4":
          this.formData12.dydytbmj = this.customValue.value;
          break;
        case "5":
          this.formData12.xydytbmj = this.customValue.value;
          break;
        case "6":
          if (this.customValue.value && this.customValue.value.includes("~")) {
            const parts = this.customValue.value.split("~");
            this.formData12.tbmjMin = parts[0].trim();
            this.formData12.tbmjMax = parts[1].trim();
          }
          break;
      }
      this.findAll();
    ...
    saveFormData() {
      localStorage.setItem("formData12", JSON.stringify(this.formData12));
    },
    loadFormData() {
      const savedData = localStorage.getItem("formData12");
      if (savedData) {
        this.formData12 = JSON.parse(savedData);
      }
    },
    ...
    beforeRouteEnter(to, from, next) {
      next((vm) => {
        if (to.params.savedData) {
          vm.formData12 = to.params.savedData;
        }
      });
    },
    handleDateChange(dates) {
      if (Array.isArray(dates) && dates.length > 0) {
        ...
        this.formData12.startDate = formattedDates[0];
        this.formData12.endDate = formattedDates[1];
      } else {
        this.formData12.startDate = "";
        this.formData12.endDate = "";
      }
    },
    emitGetData(data) {
      // console.log(data);
      this.formData12.sfwttb = data.sfwttb;
      this.formData12.hcjd = data.hcjd;
      this.formData12.pdlx = data.tblx;
      this.formData12.shengjidxjg = data.checkMethod;
      this.formData12.shijidxjg = data.illegalityType;
      this.formData12.qbtbHchpdlx = data.hchlxx;
      this.formData12.qbtbSfnrwfjs = data.deductionType;
      this.formData12.qbtbTbly = data.tbly;
      this.formData12.tbfl = data.tbfl;
      this.formData12.qbtbCancelStatus = data.qbtbCancelstatus;

      this.formData12.hcjd = data.hcjd;
      this.formData12.xmlx = data.xmlx;
      this.formData12.zglsqk = data.zglsqk;
      this.formData12.qtjtqx = data.qtjtqx;
      this.formData12.hfjtqx = data.hfjtqx;
      this.formData12.wfsjyt = data.sjyt;

      const updateFormData = (field, value, condition) => {
        switch (condition) {
          case "3":
            this.formData12[field] = value;
            break;
          case "1":
            this.formData12[`${field}Max`] = value;
            break;
          case "2":
            this.formData12[`${field}Min`] = value;
            break;
          case "4":
            this.formData12[`dydy${field}`] = value;
            break;
          case "5":
            this.formData12[`xydy${field}`] = value;
            break;
          case "6":
            const [min, max] = value.split("~");
            this.formData12[`${field}Max`] = max;
            this.formData12[`${field}Min`] = min;
            break;
        }
      };
      ...
      if (data.freck.condition === "4") {
        this.formData12.dydygdmj = data.freck.value;
      } else if (data.freck.condition === "5") {
        this.formData12.xydygdmj = data.freck.value;
      } else {
        updateFormData("gdmj", data.freck.value, data.freck.condition);
      }

      if (data.Cufreck.condition === "4") {
        this.formData12.dydynydmj = data.Cufreck.value;
      } else if (data.Cufreck.condition === "5") {
        this.formData12.xydynydmj = data.Cufreck.value;
      } else {
    ...
    listfileList(params) {
      special2024fileList(params).then((res) => {
    ...
    terDialog() {
      if (this.namerow == "") {
        ...
        this.formData12.remarks = this.namerow;
        let data = { ...this.formData12 };
    ...
    exportData() {
      ...
      special2024wscs(this.formData12)
        .then((res) => {
          if (res.code === 200) {
    ...
    handleCurrentChange(value) {
      this.formData12.pageNum = value;
      this.findAll();
    },
    handleSizeli(value) {
      this.formData12.pageSize = value;
      this.findAll();
    },
    ...
    handleChangeXzq(value) {
      this.formData12.city = "";
      this.formData12.county = "";
      if (value.length) {
        const textArr = [];
        ...
        this.formData12.city = arr.join(",");
        this.formData12.county = county.join(",");
      }
    },
    //数组转对象
    arrayToObject(arr) {
    ...
    findAll(isSearch) {
      ...
      // }
      if (this.formData12.snapdate) {
        this.formData12.snapdate = this.formatDate(this.formData12.snapdate);
      }

      const { selectXZQ, valuetime, ...params } = this.formData12;
