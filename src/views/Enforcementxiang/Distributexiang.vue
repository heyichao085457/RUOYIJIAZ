  ...
  <div class="htmlheight">
    ...
    <main class="main-content">
      ...
      <div class="right-column">
        ...
        >
          <el-tab-pane label="卫星数据属性" name="first">
            <div class="scrollable-tab-content">
              ...
              >
                <el-descriptions-item :span="1.5">
                  ...
                  {{ freckleDatalisto.countyCode }}
                </el-descriptions-item>
                <el-descriptions-item :span="1.5">
                  <template slot="label">行政区名称</template>
                  {{ freckleDatalisto.county }}
                </el-descriptions-item>
                <el-descriptions-item :span="1.5">
                  <template slot="label"> 套合面积 </template>

                  <div style="display: flex; justify-content: space-between">
                    <div>
                      {{ freckleDatalisto.thmj }}
                    </div>
                    <div>亩</div>
                  </div>
                </el-descriptions-item>
                <el-descriptions-item :span="1.5">
                  <template slot="label"> 监测面积 </template>

                  <div style="display: flex; justify-content: space-between">
                    <div>
                      {{ freckleDatalisto.jcmj }}
                    </div>
                    <div>亩</div>
                  </div>
                </el-descriptions-item>
                <el-descriptions-item :span="1.5">
                  <template slot="label"> 图斑类型 </template>
                  {{ freckleDatalisto.tblx }}
                </el-descriptions-item>
                <el-descriptions-item :span="1.5">
                  <template slot="label"> 变化前类型 </template>
                  {{ freckleDatalisto.xftblx }}
                </el-descriptions-item>
                <el-descriptions-item :span="1.5">
                  <template slot="label"> 变化后类型 </template>
                  {{ freckleDatalisto.cxbhlx }}
                </el-descriptions-item>
                <el-descriptions-item :span="1.5">
                  <template slot="label"> 变化后类型标注 </template>
                ...
                <el-descriptions-item :span="1.5">
                  <template slot="label"> 前时相日期 </template>
                  {{ freckleDatalisto.qsx }}
                </el-descriptions-item>
                <el-descriptions-item :span="1.5">
                  <template slot="label"> 后时相日期 </template>
                  {{ freckleDatalisto.hsx }}
                </el-descriptions-item>
                <el-descriptions-item :span="1.5">
                  <template slot="label"> 是否持续变化 </template>
                  {{ freckleDatalisto.hsx }}
                </el-descriptions-item>
                <el-descriptions-item :span="1.5">
                  <template slot="label"> 往期图斑编号 </template>
                  {{ freckleDatalisto.wqbh }}
                </el-descriptions-item>
                <el-descriptions-item :span="1.5">
                  <template slot="label"> 坐落位置 </template>
                  {{ freckleDatalisto.hsx }}
                </el-descriptions-item>
                <el-descriptions-item :span="1.5">
                ...
                <el-descriptions-item :span="1.5">
                  <template slot="label"> 追溯信息 </template>
                  {{ freckleDatalisto.hsx }}
                </el-descriptions-item>
                <el-descriptions-item :span="1.5">
                  <template slot="label"> 描述说明 </template>
                  {{ freckleDatalisto.hsx }}
                </el-descriptions-item>
              </el-descriptions>
              <el-descriptions
              ...
              >
                ...
                <el-descriptions-item label="有手续" :span="2">{{
                  freckleDatalisto.ysxwpdlrdgdmj
                }}</el-descriptions-item>
                <el-descriptions-item label="无手续" :span="2">{{
                  freckleDatalisto.wsxwpdlrdgdmj
                }}</el-descriptions-item>
                <el-descriptions-item
                  label="有手续部分和无手续部分之和"
                  :span="2"
                ...
                <el-descriptions-item :span="2">{{
                  freckleDatalisto.wsxwpdlrdstmj
                }}</el-descriptions-item>
                <el-descriptions-item :span="2"></el-descriptions-item>
                <!-- //------------------------// -->
                <el-descriptions-item label="" :span="2">
                ...
                <el-descriptions-item :span="2">{{
                  freckleDatalisto.ysxwpdlrdjbntmj
                }}</el-descriptions-item>
                <el-descriptions-item :span="2">{{
                  freckleDatalisto.wsxwpdlrdjbntmj
                }}</el-descriptions-item>
                <el-descriptions-item :span="2"></el-descriptions-item>
                <!-- //------------------------// -->
                <el-descriptions-item label="" :span="2">
                ...
                <el-descriptions-item :span="2">{{
                  freckleDatalisto.ysxwpdlrdnydmj
                }}</el-descriptions-item>
                <el-descriptions-item :span="2">{{
                  freckleDatalisto.wsxwpdlrdnydmj
                }}</el-descriptions-item>
                <el-descriptions-item :span="2"></el-descriptions-item>
                <!-- //------------------------// -->
                <el-descriptions-item label="" :span="2">
                ...
                <el-descriptions-item :span="2">{{
                  freckleDatalisto.ysxwpdlrdjsydmj
                }}</el-descriptions-item>
                <el-descriptions-item :span="2">{{
                  freckleDatalisto.wsxwpdlrdjsydmj
                }}</el-descriptions-item>
                <el-descriptions-item :span="2"></el-descriptions-item>
                <!-- //------------------------// -->
                <el-descriptions-item label="" :span="2">
                ...
                <el-descriptions-item :span="2">{{
                  freckleDatalisto.ysxwpdlrdwlydmj
                }}</el-descriptions-item>
                <el-descriptions-item :span="2">{{
                  freckleDatalisto.wsxwpdlrdwlydmj
                }}</el-descriptions-item>
                <el-descriptions-item :span="2"></el-descriptions-item>
                <!-- //------------------------// -->
                <el-descriptions-item label="" :span="2">
              ...
              >
                <el-descriptions-item :span="1.5">
                  ...
                  {{ freckleDatalisto.mjzbzdxianjidm }}
                </el-descriptions-item>
                <el-descriptions-item :span="1.5">
                  <template slot="label">
                    面积占比最大的三调县级行政区名称
                  </template>
                  {{ freckleDatalisto.mjzbzdxianjimc }}
                </el-descriptions-item>
                <el-descriptions-item :span="1.5">
                  <template slot="label">
                    面积占比最大的乡镇级行政区代码
                  </template>
                  {{ freckleDatalisto.mjzbzdxzjdm }}
                </el-descriptions-item>
                <el-descriptions-item :span="1.5">
                  <template slot="label">
                    面积占比最大的乡镇级行政区名称
                  </template>
                  {{ freckleDatalisto.mjzbzdxzjmc }}
                </el-descriptions-item>
                <el-descriptions-item :span="1.5">
                  <template slot="label">
                    面积占比最大的村级行政区代码
                  </template>
                  {{ freckleDatalisto.mjzbzbcjdm }}
                </el-descriptions-item>
                <el-descriptions-item :span="1.5">
                  <template slot="label">
                    面积占比最大的村级行政区名称
                  </template>
                  {{ freckleDatalisto.mjzbzbcjmc }}
                </el-descriptions-item>
              </el-descriptions>
              <el-descriptions
                class="my-label"
              ...
              >
                <el-descriptions-item :span="3">
                  ...
                  <div style="display: flex; justify-content: space-between">
                    <div>
                      {{ freckleDatalisto.zjnzyjsydxm }}
                    </div>
                    <div>亩</div>
                  </div>
                </el-descriptions-item>
                <el-descriptions-item :span="3">
                  <template slot="label"> 土地整治验收项目 </template>
                  <div style="display: flex; justify-content: space-between">
                    <div>
                      {{ freckleDatalisto.tdzzysxm }}
                    </div>
                    <div>亩</div>
                  </div>
                </el-descriptions-item>
                ...
                <el-descriptions-item :span="3">
                  ...
                  <div style="display: flex; justify-content: space-between">
                    <div>
                      {{ freckleDatalisto.gkfqdfgxm }}
                    </div>
                    <div>亩</div>
                  </div>
                </el-descriptions-item>
                <el-descriptions-item :span="1.5">
                  <template slot="label"> 2018 年前未利用地开发项目 </template>
                  <div style="display: flex; justify-content: space-between">
                    <div>
                      {{ freckleDatalisto.wlydkfxm }}
                    </div>
                    <div>亩</div>
                  </div>
                </el-descriptions-item>
              ...
              >
                ...
                <el-descriptions-item label="批准文号" :span="1.5">{{
                  freckleDatalisto.ysxwpdlrdgdmj
                }}</el-descriptions-item>
                <el-descriptions-item label="批文类型" :span="1.5">{{
                  freckleDatalisto.wsxwpdlrdgdmj
                }}</el-descriptions-item>
                <el-descriptions-item label="批准时间" :span="1.5">{{
                  freckleDatalisto.wsxwpdlrdgdmj
                }}</el-descriptions-item>
                <el-descriptions-item label="批准面积" :span="1.5">{{
                  freckleDatalisto.wsxwpdlrdgdmj
                }}</el-descriptions-item>
                <el-descriptions-item label="耕地面积" :span="1.5">{{
                  freckleDatalisto.dlrdgdmj
                }}</el-descriptions-item>
              </el-descriptions>
              <!-- <el-descriptions
                class="my-label"
