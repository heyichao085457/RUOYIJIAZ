      ...
      <div class="right-column">
        ...
        >
          ...
          <el-tab-pane label="操作记录">
            <div class="scrollable-tab-content">
              <el-table :data="czjldata" style="width: 100%">
                <el-table-column align="center" type="index" label="id">
                </el-table-column>
                <el-table-column
                  prop="modifyTime"
                ...
                >
                  <template slot-scope="scope">
                    <el-tooltip
                      :content="scope.row.modifyContent"
                      placement="top"
                      effect="dark"
                    >
                      <div class="address-cellcz">
...
export default {
  ...
  methods: {
    operatio() {
      ...
      operation2024(params).then((ok) => {
        // console.log(ok);
        this.czjldata.push(ok.data);
      });
    },
    ...
    rhtzByFreckl() {
      ...
      rhtzByFreckleCode(params).then((ok) => {
        ...
        this.formDatarw.sfxh.sfxh = ok.data.集中举证.sfxh;
        this.cancelte = ok.data.集中举证.cancelDate;
        this.formDatarw.jzjd = ok.data.集中举证.jzjd;
      });
    },
    formatText(text) {
