          ...
          <el-main class="el-maindata">
            <div>
              ...
              >
                ...
                <el-table-column prop="zxgzName" label="附件名称" width="200">
                </el-table-column>
                <el-table-column prop="zxgzType" label="附件类型" width="200">
                </el-table-column>
...
export default {
  ...
  computed: {
    ...
    uploadAction() {
      return `${process.env.VUE_APP_BASE_API}/ZxgzWjj/upload/zxgzFile2022`;
    },
  },
  methods: {
    tdwpWjjListt() {
    ...
    inputonfun() {
      ...
      zxgzFileInfo2022(params).then((ok) => {
        console.log(ok);
        this.Datalongtow = ok.data;
      });
    },
