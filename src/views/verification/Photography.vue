          ...
          <el-main class="el-maindata">
            <div>
              ...
              >
                ...
                <el-table-column prop="tdwpType" label="附件类型" width="200">
                </el-table-column>
...
export default {
  ...
  computed: {
    ...
    uploadAction() {
      return `${process.env.VUE_APP_BASE_API}/TdwpWjj/upload/tdwpFile2023`;
    },
  },
  methods: {
    tdwpWjjListt() {
    ...
    inputonfun() {
      ...
      tdwpFileInfo2023(params).then((ok) => {
        console.log(ok);
        this.Datalongtow = ok.data;
      });
    },
