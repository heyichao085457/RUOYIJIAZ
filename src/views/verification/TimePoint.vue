<template>
  <div class="app-title">
    <el-card class="box-card" v-for="(item, index) in Datacard" :key="index">
      <div class="box-div" @click="boxcardClick(index, item)">
        <div>
...
export default {
  ...
  computed: {
    ...
    uploadAction() {
      let path =
        this.ixd === 4 ? "upload/standingBook2023" : "upload/standingBook2023";
      return `${process.env.VUE_APP_BASE_API}/rhtzWjj/${path}`;
    },
  },
  methods: {
    tdwpWjjListt() {
