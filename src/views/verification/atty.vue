<template>
      ...
      <el-row :gutter="20">
        ...
        <el-col :span="20" :xs="24">
          ...
          <el-pagination
            ...
            :current-page="this.formData1.pageNum"
            :page-sizes="[20, 50, 100, 150]"
            :page-size="this.formData1.pageSize"
  ...
  import { hcglTree, listwyhc, areas } from "../../api/document/index";
  ...
  export default {
    ...
    methods: {
      ...
      handleSizeChange(newSize) {
        this.formData1.pageSize = newSize;
        this.list1();
      },
      handleCurrentChange(newPage) {
        this.formData1.pageNum = newPage;
        this.list1();
      },
      list1() {
        listwyhc(this.formData1).then((ok) => {
          if (ok.code == 200) {
      ...
      handleNodeClick(data) {
        let Listop = [
          { prop: "index1", label: "序号", width: "70", align: "center" },
          ...
          { prop: "landCode", label: "地块编号", width: "235", align: "center" },
          ...
          { prop: "wyhcTbly", label: "图斑来源", width: "115", align: "center" },
          {
            prop: "sjysyj",
            label: "省级预审意见",
            width: "280",
