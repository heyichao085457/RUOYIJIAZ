  ...
  <div class="poler">
    ...
    <div class="scrollable-tab-content">
      ...
      >
        ...
        <el-table-column prop="address" label="检测编号" show-overflow-tooltip>
        </el-table-column>
        <el-table-column prop="address" label="下发时间" show-overflow-tooltip>
        </el-table-column>
        <el-table-column prop="address" label="处理状态" show-overflow-tooltip>
        </el-table-column>
        <el-table-column prop="address" label="套合面积" show-overflow-tooltip>
        </el-table-column>
        <el-table-column prop="address" label="耕地面积" show-overflow-tooltip>
        </el-table-column>
        <el-table-column
          prop="address"
          label="检测图斑类型"
        ...
        <el-table-column prop="address" label="是否涉矿" show-overflow-tooltip>
        </el-table-column>
        <el-table-column prop="address" label="是否拆分" show-overflow-tooltip>
        </el-table-column>
        <el-table-column
          prop="address"
          label="持续变化类型"
